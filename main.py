...
lizard_r = [pygame.image.load("resources\\characters\\MONSTERS\\lizard\\Walk%s.png"%frame) for frame in range(1,7)]
lizard_l = [pygame.transform.flip(pygame.image.load("resources\\characters\\MONSTERS\\lizard\\Walk%s.png"%frame),True,False) for frame in range(1,7)]
lizard_attack_r =[pygame.image.load("resources\\characters\\MONSTERS\\lizard\\Attack%s.png"%frame) for frame in range(1,6)]
lizard_attack_l = [pygame.transform.flip(pygame.image.load("resources\\characters\\MONSTERS\\lizard\\Attack%s.png"%frame),True,False) for frame in range(1,6)]

small_dragon_r = [pygame.image.load("resources\\characters\\MONSTERS\\small_dragon\\Walk%s.png"%frame) for frame in range(1,5)]
small_dragon_l =[pygame.transform.flip(pygame.image.load("resources\\characters\\MONSTERS\\small_dragon\\Walk%s.png"%frame),True,False) for frame in range(1,5)]
small_dragon_attack_r = [pygame.image.load("resources\\characters\\MONSTERS\\small_dragon\\Attack%s.png"%frame) for frame in range(1,4)]
small_dragon_attack_l = [pygame.transform.flip(pygame.image.load("resources\\characters\\MONSTERS\\small_dragon\\Attack%s.png"%frame),True,False) for frame in range(1,4)]

jinn_r = [pygame.image.load("resources\\characters\\MONSTERS\\jinn_animation\\Flight%s.png"%frame) for frame in range(1,5)]
jinn_l = [pygame.transform.flip(pygame.image.load("resources\\characters\\MONSTERS\\jinn_animation\\Flight%s.png"%frame),True,False) for frame in range(1,5)]
jinn_attack_r = [pygame.image.load("resources\\characters\\MONSTERS\\jinn_animation\\Attack%s.png"%frame) for frame in range(1,5)]
jinn_attack_l = [pygame.transform.flip(pygame.image.load("resources\\characters\\MONSTERS\\jinn_animation\\Attack%s.png"%frame),True,False) for frame in range(1,5)]

demon_r = [pygame.image.load("resources\\characters\\MONSTERS\\demon\\Walk%s.png"%frame) for frame in range(1,7)]
demon_l = [pygame.transform.flip(pygame.image.load("resources\\characters\\MONSTERS\\demon\\Walk%s.png"%frame),True,False) for frame in range(1,7)]
demon_attack_r = [pygame.image.load("resources\\characters\\MONSTERS\\demon\\Attack%s.png"%frame) for frame in range(1,5)]
demon_attack_l = [pygame.transform.flip(pygame.image.load("resources\\characters\\MONSTERS\\demon\\Attack%s.png"%frame),True,False) for frame in range(1,5)]

medusa_r = [pygame.image.load("resources\\characters\\MONSTERS\\medusa\\Walk%s.png"%frame) for frame in range(1,5)]
medusa_l = [pygame.transform.flip(pygame.image.load("resources\\characters\\MONSTERS\\medusa\\Walk%s.png"%frame),True,False) for frame in range(1,5)]
medusa_attack_r = [pygame.image.load("resources\\characters\\MONSTERS\\medusa\\Attack%s.png"%frame) for frame in range(1,7)]
medusa_attack_l =[pygame.transform.flip(pygame.image.load("resources\\characters\\MONSTERS\\medusa\\Attack%s.png"%frame),True,False) for frame in range(1,7)]
